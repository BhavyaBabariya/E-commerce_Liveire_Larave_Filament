      ...
      <div class="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
        ...
        <div class="col-span-1">
          ...
          <div class="grid mt-3 space-y-3">
            <p><a wire:navigate class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/categories">Categories</a></p>
            <p><a wire:navigate class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products">All Products</a></p>
            <p><a wire:navigate class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products">Featured Products</a></p>
          </div>
        </div>
        <!-- End Col -->
